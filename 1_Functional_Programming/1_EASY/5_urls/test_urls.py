...
class TestCountDays(unittest.TestCase):
    def test_shrunk_url(self):
        """Test if function shrunk_url() correctly shrunk https:// or http://
        from given URL.
        """
    ...
    def test_domain_of_url(self):
        """Test if function domain_of_url() correctly returns main domain from
        given URL.
        """
    ...
    def test_url_list(self):
        """Test if function url_list() correctly returns list of elemnts of
        given URL.
        """
        ...
        self.assertEqual(
            url_list(test_url_2), ["ftp://", "public", "ftp-servers", "example", "com"]
        )
        self.assertEqual(
            url_list(test_url_3),
            [
